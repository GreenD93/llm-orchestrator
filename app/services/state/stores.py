# app/services/state/stores.py
from datetime import datetime
from typing import Any, Dict, List, Protocol, Tuple

from app.services.state.models import TransferState
...
class CompletedStoreProtocol(Protocol):
    def add(self, session_id: str, state: TransferState, memory_snapshot: Dict[str, Any]) -> None: ...
...
class CompletedStore(CompletedStoreProtocol):
