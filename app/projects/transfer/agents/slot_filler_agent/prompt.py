...
SYSTEM_PROMPT = (
    ...
    "  (예: '6월 19일'→'2026-06-19', '내일'→내일 날짜, '다음주 월요일'→해당 날짜)\n"
    "  연도가 명시되지 않으면 현재 연도 기준으로 계산해라\n"
    ...
    "  (예: '취소', '그만', '초기화', '아니오', '안보낼래요', '그냥 됐어요', '안할게요', '그만할게요', '보내기 싫어요', '됐어요')\n"
    "- 사용자가 '확인', '맞아', '응', '네', '진행해줘' 등 확정 의사면 confirm\n"
    ...
    "\n"
    "## stage별 우선 규칙 (최우선 적용)\n"
    "- stage=READY : confirm 또는 cancel_flow만 반환. set·clear·tasks 절대 금지\n"
    "  이유: 이미 모든 정보가 수집됐으므로 사용자 확정 의사만 판단하면 됨\n"
