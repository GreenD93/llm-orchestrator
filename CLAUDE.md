...
│                                                               │
│   self.runner.run("slot", ctx)                                │
│   self.runner.run_stream("interaction", ctx)                  │
│        │                                                      │
│        ▼                                                      │
│   ┌─────────── AgentRunner ───────────┐                       │
│   │  이름으로 Agent 조회               │                       │
│   │  retry · timeout · 스키마 검증     │   delta               │
│   │  TurnTracer 자동 기록             │──────────┐            │
│   │                                   │          │            │
│   │   agent.run(ctx) / run_stream()   │          │            │
│   │        │                          │          │            │
│   │        ▼                          │          │            │
│   │   ┌─────────┐                    │          │            │
│   │   │  Agent  │ reads only         │          │            │
│   │   │ (읽기만)│──→ ExecutionContext │          │            │
│   │   └─────────┘                    │          │            │
│   └───────────────────────────────────┘          │            │
│                                                   ▼            │
│                                          ┌──────────────┐     │
